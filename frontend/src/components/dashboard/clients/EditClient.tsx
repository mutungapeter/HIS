...
import { useUpdateClientMutation } from "@/redux/services/clients/clients";
  ...
  const onSubmit = async (formData: z.infer<typeof createClientSchema>) => {
    try {
      ...
      if (error && typeof error === "object" && "data" in error && error.data) {
        ...
        setIsError(true);
        setSuccessMessage("Failed to update client. Please try again.");
        setShowSuccessModal(true);
      }
    }
  };
              ...
              <>
                ...
                >
                  ...
                  <div className="sticky bottom-0 bg-white z-40 flex md:px-6 gap-4 md:justify-end items-center py-3">
                    ...
                    <button
                      type="submit"
                      disabled={isSubmitting || isUpdatingClient}
