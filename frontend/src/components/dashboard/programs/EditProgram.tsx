...
import { useUpdateProgramMutation } from "@/redux/services/healthPrograms/healthPrograms";
...
const EditProgram = ({
  ...
  const onSubmit = async (formData: z.infer<typeof programSchema>) => {
    try {
      ...
      setIsError(false);
      setSuccessMessage("Health program updated successfully!");
      ...
      if (error && typeof error === "object" && "data" in error && error.data) {
        ...
        setIsError(true);
        setSuccessMessage("Failed to update Health program . Please try again.");
        setShowSuccessModal(true);
      }
    }
  };
          ...
          >
            <div
              className="relative transform justify-center animate-fadeIn max-h-[90vh]
                ...
                w-full sm:max-w-c-650 md:max-w-650 px-3"
            >
              <>
