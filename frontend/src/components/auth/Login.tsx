  ...
  return (
    <>
      {isRedirecting ? (
        ...
        <div className="bg-[#F4F7FA] min-h-screen flex items-center w-full justify-center md:px-0 px-4 py-4 font-nunito">
          <div className="bg-white rounded-sm shadow-lg -md w-full max-w-c-450  overflow-hidden   flex flex-col md:flex-row">
            <div className="p-6 w-full">
              <div className="flex items-center md:items-start justify-center mb-6 ">
                <Link href="/" className="cursor-pointer"></Link>
                <div className="flex flex-col text-center">
                  <h2 className="text-xl font-roboto tracking-tight text-primary uppercase">
                    HIS
                  </h2>
